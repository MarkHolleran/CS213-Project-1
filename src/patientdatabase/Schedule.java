...
/**
 * Class that stores an array of Appointments equipped with functions
 * such as add, remove, and find to assist kiosk commands.
 *
 * There are multiple functions to even help print, sort, and select Appointments
